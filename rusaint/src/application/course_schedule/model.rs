...
impl LectureCategory {
    ...
    async fn request_lv3(
        ...
        let lv1_event = ElementParser::new(client.body())?.read(ComboBoxSelectByValue1Command::new(lv1, value_lv1, false))?;
        client.process_event(false, lv1_event).await?;
        let lv2_event = ElementParser::new(client.body())?.read(ComboBoxSelectByValue1Command::new(lv2, value_lv2, false))?;
