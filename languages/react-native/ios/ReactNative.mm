...
namespace uniffi_generated {
    ...
    */
    ...
    public:
        NativeReactNativeSpecJSI(const ObjCTurboModule::InitParams &params);
    ...
    NativeReactNativeSpecJSI::NativeReactNativeSpecJSI(const ObjCTurboModule::InitParams &params)
